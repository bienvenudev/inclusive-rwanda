...
const Home: React.FC = () => {
  return (
    <main id="main-content" className="min-h-[calc(100vh-80px)] py-8">
      {/* Hero Section */}
      <section className="text-center py-16 bg-gradient-to-br from-secondary to-tertiary mx-[-1rem] mb-16 rounded-none md:rounded-xl">
      ...
      <section className="py-16 text-center bg-secondary mx-[-1rem] my-16 rounded-none md:rounded-xl">
        <div className="px-4">
          <h2 className="text-3xl md:text-4xl font-semibold mb-8 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
            <div className="bg-tertiary border border-gray-600 p-6 rounded-lg transition-all duration-300 hover:border-blue-500 hover:-translate-y-1">
      ...
      <section className="py-16 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="bg-secondary border border-gray-600 p-8 rounded-xl transition-all duration-300 hover:border-blue-500 hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-500/15">
      ...
      <section className="py-16 text-center bg-[var(--bg-secondary)] mx-[-1rem] my-16 rounded-none md:rounded-xl">
        <div className="px-4">
          <h2 className="text-3xl md:text-4xl font-semibold mb-8 text-[var(--text-primary)]">
            See Accessibility in Action
          </h2>
          <p className="text-base md:text-lg text-[var(--text-secondary)] max-w-3xl mx-auto mb-12 leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            {/* Color Contrast Demo */}
            <div className="bg-[var(--bg-tertiary)] border border-[var(--border-default)] p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-[var(--accent-primary)] mb-4">Color Contrast Example</h3>
            ...
            {/* Alt Text Demo */}
            <div className="bg-[var(--bg-tertiary)] border border-[var(--border-default)] p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-[var(--accent-primary)] mb-4">Alt Text Importance</h3>
              <div className="space-y-4">
            ...
            <div className="bg-[var(--bg-tertiary)] border border-[var(--border-default)] p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-[var(--accent-primary)] mb-4">Keyboard Navigation</h3>
              <div className="space-y-4">
                <p className="text-sm text-[var(--text-secondary)] mb-3">
                  Try pressing Tab to navigate through these buttons:
                </p>
                <div className="flex flex-wrap gap-2 justify-center">
                  <button className="px-3 py-2 bg-[var(--accent-primary)] text-white rounded text-sm hover:bg-[var(--accent-hover)] focus:ring-2 focus:ring-[var(--accent-focus)] focus:ring-offset-2 focus:ring-offset-[var(--bg-tertiary)]">
                    Button 1
                  </button>
                  <button className="px-3 py-2 bg-[var(--accent-primary)] text-white rounded text-sm hover:bg-[var(--accent-hover)] focus:ring-2 focus:ring-[var(--accent-focus)] focus:ring-offset-2 focus:ring-offset-[var(--bg-tertiary)]">
                    Button 2
            ...
            <div className="bg-[var(--bg-tertiary)] border border-[var(--border-default)] p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-[var(--accent-primary)] mb-4">Proper Heading Structure</h3>
              <div className="text-left space-y-2">
                <div className="text-2xl font-bold text-[var(--text-primary)]">H1: Main Page Title</div>
                <div className="text-xl font-semibold text-[var(--text-primary)] ml-4">H2: Section Title</div>
                <div className="text-lg font-medium text-[var(--text-primary)] ml-8">H3: Subsection</div>
                <div className="text-base text-[var(--text-primary)] ml-12">H4: Sub-subsection</div>
      ...
      <section className="py-16 text-center">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative">
            {/* Progress Line */}
            <div className="absolute top-1/2 left-0 w-full h-1 bg-[var(--border-default)] rounded-full transform -translate-y-1/2 hidden md:block"></div>
            <div className="absolute top-1/2 left-0 w-1/4 h-1 bg-[var(--accent-primary)] rounded-full transform -translate-y-1/2 hidden md:block"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              {/* Step 1: You Are Here */}
              <div className="relative">
                <div className="bg-[var(--accent-primary)] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-xl shadow-lg">
                  ✓
                </div>
                <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-2">Getting Started</h3>
                <p className="text-sm text-[var(--text-secondary)] mb-3">Understanding the basics</p>
                <div className="bg-[var(--accent-primary)] text-white px-3 py-1 rounded-full text-xs font-medium">
                  You are here!
                </div>
                <p className="text-xs text-[var(--text-muted)] mt-2">⏱️ 10 minutes</p>
              </div>

              {/* Step 2: Why It Matters */}
              <div className="relative">
                <div className="bg-[var(--bg-secondary)] border-2 border-[var(--accent-primary)] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-[var(--accent-primary)] font-bold text-xl">
                  2
                </div>
                <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-2">Why It Matters</h3>
                <p className="text-sm text-[var(--text-secondary)] mb-3">Learn the impact and importance</p>
                <Link
                  to="/why-it-matters"
                  className="bg-[var(--bg-secondary)] hover:bg-[var(--bg-tertiary)] border border-[var(--border-default)] text-[var(--text-primary)] px-4 py-2 rounded-md text-sm transition-colors duration-200 inline-block"
                >
                  Start Learning
                </Link>
                <p className="text-xs text-[var(--text-muted)] mt-2">⏱️ 15 minutes</p>
              </div>

              {/* Step 3: Quick Start */}
              <div className="relative">
                <div className="bg-[var(--bg-secondary)] border-2 border-[var(--border-default)] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-[var(--text-muted)] font-bold text-xl">
                  3
                </div>
                <h3 className="text-lg font-semibold text-[var(--text-muted)] mb-2">Quick Start Guide</h3>
                <p className="text-sm text-[var(--text-muted)] mb-3">Hands-on implementation tips</p>
                <button disabled className="bg-[var(--bg-secondary)] border border-[var(--border-default)] text-[var(--text-muted)] px-4 py-2 rounded-md text-sm cursor-not-allowed opacity-60">
                  Locked
                </button>
                <p className="text-xs text-[var(--text-muted)] mt-2">⏱️ 25 minutes</p>
              </div>
              ...
              <div className="relative">
                ...
                <h3 className="text-lg font-semibold text-[var(--text-muted)] mb-2">Resources & Tools</h3>
                <p className="text-sm text-[var(--text-muted)] mb-3">Deep dive into tools and community</p>
                <button disabled className="bg-[var(--bg-secondary)] border border-[var(--border-default)] text-[var(--text-muted)] px-4 py-2 rounded-md text-sm cursor-not-allowed opacity-60">
                  Locked
                </button>
                <p className="text-xs text-[var(--text-muted)] mt-2">⏱️ 20 minutes</p>
              </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[var(--bg-secondary)] border border-[var(--border-default)] p-4 rounded-lg">
              <div className="text-2xl font-bold text-[var(--accent-primary)] mb-1">70min</div>
              <div className="text-sm text-[var(--text-secondary)]">Total Learning Time</div>
            </div>
            <div className="bg-[var(--bg-secondary)] border border-[var(--border-default)] p-4 rounded-lg">
              <div className="text-2xl font-bold text-[var(--accent-primary)] mb-1">4</div>
              <div className="text-sm text-[var(--text-secondary)]">Learning Modules</div>
            </div>
            <div className="bg-[var(--bg-secondary)] border border-[var(--border-default)] p-4 rounded-lg">
              <div className="text-2xl font-bold text-[var(--accent-primary)] mb-1">∞</div>
              <div className="text-sm text-[var(--text-secondary)]">Impact Potential</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Get Started Section */}
      <section className="py-16 text-center">
        <h2 className="text-3xl md:text-4xl font-semibold mb-4 text-[var(--text-primary)]">
          Ready to Start Your Journey?
        </h2>
        <p className="text-base md:text-lg text-[var(--text-secondary)] max-w-2xl mx-auto mb-8 px-4">
          Now that you understand the basics, let's explore why accessibility matters for Rwanda's digital future.
        </p>
        <Link
          to="/why-it-matters"
          className="inline-flex items-center bg-[var(--accent-primary)] hover:bg-[var(--accent-hover)] text-white px-8 py-4 rounded-lg text-lg font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[var(--accent-focus)] focus:ring-offset-2 focus:ring-offset-[var(--bg-primary)]"
        >
