  ...
  return (
    <main id="main-content" className="min-h-[calc(100vh-80px)] py-8">
      ...
      <section className="py-16">
        <h2 className="text-3xl md:text-4xl font-semibold mb-8 text-center text-[var(--text-primary)]">
        ...
        <div className="max-w-4xl mx-auto space-y-4">
          {[
            ...
            <div
              key={item.id}
              className="flex items-center p-4 bg-[var(--bg-secondary)] border border-[var(--border-default)] rounded-lg hover:border-[var(--accent-primary)] transition-colors duration-200"
            >
              <button
              ...
              <div className="flex-1">
                <span className={`text-[var(--text-primary)] ${checkedItems.includes(item.id) ? 'line-through opacity-60' : ''}`}>
                  {item.text}
                </span>
        ...
        <div className="text-center mt-8">
          ...
          <div className="w-full max-w-md mx-auto mt-2 bg-[var(--bg-secondary)] rounded-full h-2">
            <div
      ...
      <section className="py-16 bg-[var(--bg-secondary)] mx-[-1rem] my-16 rounded-none md:rounded-xl">
        <div className="px-4">
          ...
          {/* Tab Navigation */}
          <div className="flex flex-wrap justify-center mb-8 bg-[var(--bg-tertiary)] rounded-lg p-1 max-w-4xl mx-auto">
            {[
            ...
            {activeTab === 'semantic' && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div>
                  ...
                  <div className="bg-[var(--bg-primary)] border border-[var(--border-default)] rounded-lg p-4 font-mono text-sm">
      ...
      <section className="py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-[var(--bg-secondary)] border border-[var(--border-default)] p-6 rounded-lg">
            <div className="w-12 h-12 bg-[var(--accent-primary)] rounded-lg flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" />
              </svg>
            </div>
            <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-2">Keyboard Testing</h3>
          ...
          <div className="bg-[var(--bg-secondary)] border border-[var(--border-default)] p-6 rounded-lg">
            ...
            <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-2">Screen Reader</h3>
            <p className="text-[var(--text-secondary)] text-sm mb-3">
          ...
          <div className="bg-[var(--bg-secondary)] border border-[var(--border-default)] p-6 rounded-lg">
            ...
            <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-2">Browser DevTools</h3>
            <p className="text-[var(--text-secondary)] text-sm mb-3">
          ...
          <div className="bg-[var(--bg-secondary)] border border-[var(--border-default)] p-6 rounded-lg">
            ...
            <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-2">Color Contrast</h3>
            <p className="text-[var(--text-secondary)] text-sm mb-3">
          ...
          <div className="bg-[var(--bg-secondary)] border border-[var(--border-default)] p-6 rounded-lg">
            ...
            <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-2">WAVE Tool</h3>
            <p className="text-[var(--text-secondary)] text-sm mb-3">
          ...
          <div className="bg-[var(--bg-secondary)] border border-[var(--border-default)] p-6 rounded-lg">
            ...
            <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-2">User Testing</h3>
            <p className="text-[var(--text-secondary)] text-sm mb-3">
      ...
      <section className="py-16 text-center bg-[var(--bg-secondary)] mx-[-1rem] my-16 rounded-none md:rounded-xl">
        <div className="px-4">
          ...
          <div className="mt-8 text-sm text-[var(--text-muted)]">
            ⏱️ Final section: <span className="text-[var(--accent-primary)]">Resources & Community</span> (20 minutes)
          </div>
        </div>
      </section>
    </main>
