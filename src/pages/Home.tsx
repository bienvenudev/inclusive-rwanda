          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="p-6 rounded-xl border-2 border-red-500/50 bg-red-500/10">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="font-semibold text-red-400">Poor Contrast</span>
                  </div>
                ...
                <div className="p-6 rounded-xl border-2 border-emerald-500/50 bg-emerald-500/10">
                  <div className="flex items-center mb-2">
                    <span className="text-2xl mr-2">✅</span>
                    <span className="font-semibold text-emerald-400">Good Contrast</span>
                  </div>
                ...
                <div className="text-center">
                  <p className="text-sm text-gray-400">
                    💡 Color contrast ratio should be at least <span className="text-purple-400 font-semibold">4.5:1</span> for normal text
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card rounded-2xl p-8 border border-white/10">
              ...
              <div className="space-y-6">
                <div className="p-6 rounded-xl border-2 border-red-500/50 bg-red-500/10">
                  ...
                  <div className="text-center">
                    <span className="text-2xl mr-2">🔊</span>
                    <span className="text-gray-300">Screen reader says: </span>
            ...
            <div className="glass-card rounded-2xl p-8 border border-white/10">
              ...
              <div className="space-y-6">
                ...
                <div className="text-center">
                  <p className="text-sm text-gray-400">
                    💡 Notice the focus indicators (purple glow) as you tab through
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="mt-6 p-4 bg-white/5 rounded-xl">
                  <p className="text-sm text-gray-400 italic">
                    💡 Screen readers use this hierarchy to help users navigate content efficiently
                  </p>
                </div>
              </div>
            </div>
