        ...
        <div className="container relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div className="group glass-card p-8 rounded-2xl glow-on-hover border border-white/10">
              <div className="w-16 h-16 rounded-2xl bg-purple-600 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="group glass-card p-10 rounded-2xl text-center glow-on-hover border border-white/10">
              <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-purple-600 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="py-20 lg:py-32 relative">
        <div className="container relative">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-purple-600 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-purple-600 transition-colors duration-300">Join Community</h3>
            ...
            <div className="group glass-card p-8 rounded-2xl glow-on-hover border border-white/10 text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-purple-600 transition-colors duration-300">Share Resource</h3>
